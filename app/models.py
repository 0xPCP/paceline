...
class User(db.Model, UserMixin):
    ...
    email_verified = db.Column(db.Boolean, default=True, nullable=False, server_default='true')
...
class Club(db.Model):
    ...
    featured_rank = db.Column(db.Integer, nullable=True)
...
class Ride(db.Model):
    ...
    is_newbie_friendly = db.Column(db.Boolean, default=False, nullable=False, server_default='false')
